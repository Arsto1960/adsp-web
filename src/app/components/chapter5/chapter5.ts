...
export class Chapter5 {
 questions = [
  {
    text: '1️⃣Vector quantization extends scalar quantization by:',
    options: [
  ...
  {
    text: '3️⃣The Voronoi region of a codeword consists of:',
    options: [
  ...
  {
    text: '4️⃣The distortion criterion minimized by the LBG algorithm is:',
    options: [
  ...
  {
    text: '5️⃣The two iterative steps of the LBG algorithm correspond to:',
    options: [
  ...
  {
    text: '6️⃣The LBG algorithm stops when:',
    options: [
